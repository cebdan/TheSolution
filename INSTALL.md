...
### Требования к языку и интерфейсу
...
- **Названия переменных**: На английском языке, в snake_case
- **Названия функций**: На английском языке, в snake_case
- **Названия классов**: На английском языке, в PascalCase
- **Диалоги и сообщения**: На английском языке
- **Документация**: Может быть на русском языке

### Примеры правильного кодирования
```python
# ✅ Правильно - комментарии на английском
def create_3d_object(object_type, dimensions):
    """Create a 3D object with specified type and dimensions"""
    pass

# ❌ Неправильно - комментарии на русском
...
### GUI требования
- Все диалоги и сообщения должны быть на английском языке
- Названия кнопок, меню и элементов интерфейса на английском
